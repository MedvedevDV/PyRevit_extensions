...
titleText = "Сквозная нумерация квартир"  # текст, который появляется в строке заголовка GUI
...
class WinForm(Form):
    ...
    def __init__(self):
        ...
        self.Controls.Add(self.add_txtbox_label(1, "Начальный номер квартиры"))
