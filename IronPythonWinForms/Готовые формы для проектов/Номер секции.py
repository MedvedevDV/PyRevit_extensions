...
winSize = Size(400, 250)  # размеры winform (ширина(min = 300), высота).
...
class WinForm(Form):
    ...
    def okButton_pressed(self, sender, args):
        ...
        try:
            ...
            for i in range(len(chBox_checks)):
                out.insert((self.lst_checkbox_index)[i] - 1, chBox_checks[i])
    ...
    def __init__(self):
        ...
        self.Controls.Add(self.add_txtbox_label(1, "Новый номер секции"))
