...
class WinForm(Form):
    ...
    def __init__(self):
        ...
        for i in ['ф1','ф2','ф3','ф4','ф5']:
            self.checkbox = self.add_CHECKBOX(uiWidth, self.start_position, i + '1', i) # создаем переменную фложка
            self.chBox_checks.append(self.checkbox) # нужно все флажки добавить в список именно с таким названием. Иначе не заработает
            self.lst_checkbox_index.append(self.start_position)
